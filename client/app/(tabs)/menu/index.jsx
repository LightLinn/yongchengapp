  ...
  const sections = [
    ...
    },
    {
      ...
      features: [
        ...
        { name: '每日檢點總表', icon: '', screenName: '每日檢點總表', screen: '/screens/worklog/VenueSelectScreen2?type=daily', action: 'can_view' },
        { name: '定時巡檢', icon: '', screenName: '定時巡檢', screen: '/screens/worklog/PeriodicChecklistScreen', action: 'can_view' },
        { name: '定時巡檢總表', icon: '', screenName: '定時巡檢總表', screen: '/screens/worklog/VenueSelectScreen2?type=periodic', action: 'can_view' },
        { name: '特殊處理', icon: '', screenName: '特殊處理', screen: '/screens/worklog/SpecialChecklistScreen', action: 'can_view' },
        { name: '特殊處理總表', icon: '', screenName: '特殊處理總表', screen: '/screens/worklog/VenueSelectScreen2?type=special', action: 'can_view' },
      ],
    },
    {
      title: '出勤管理',
